...
G_FLUJO = [
    ...
    ("TIR y VAN del accionista", "FCF + desembolsos (t ≤ 0), CFADS − servicio (t ≥ 1); VAN a tasa del accionista. Excel y el artefacto muestran la TIR real del accionista; si el flujo no tiene TIR única en dominio (o no hay deuda), «n/a».", f"TIR {pct('X_TIReq')} vs proyecto {pct('X_TIR')}; VAN {usd('X_VANeq')} USD; léala con el DSCR.", "#TIR_Equity"),
