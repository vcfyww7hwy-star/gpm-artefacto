...
CONFIRM_WHY = {   # por qué cada supuesto marcado «· por confirmar» sigue abierto (12 §B); las claves deben cubrir todas las entradas marcadas
    ...
    "Peaje_SGDA": "valor no publicado por ARCONEL — bloque B: Base y Custom 0,5 ¢, Conservador 1,5 ¢, Favorable 0; 10 §B y §E lo barren.",
    ...
    # ronda 2 (doc 13 P5)
    "Disponibilidad": "garantía de disponibilidad del contrato de O&M de Exergy (típica 98–99 %); bloque B 98 / 97 / 98 / 99 %.",
    "Escalacion_CAPEX": "índice de precios de módulos e inversores hasta la compra (2027–28); bloque B 3 / 5 / 3 / 0 %/año desde el 22-jul-2026.",
